...
const WIDGET_TYPES = [
  ...
  { type: 'correlogram',  label: 'Correlogram',    icon: '🔲' },
  { type: 'table',        label: 'Data Table',     icon: '🔢' },
  { type: 'density',      label: 'Density Chart',  icon: '🌫' },
  ...
  { type: 'mekko',        label: 'Mekko Chart',    icon: '▥' },
  { type: 'network',      label: 'Network Chart',  icon: '🌳' },
  ...
  { type: 'straighttable',label: 'Straight Table', icon: '▦' },
